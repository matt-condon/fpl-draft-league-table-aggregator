...
function setTableFromJsonData(data) {
    ...
    eventElement.textContent = `Gameweek ${gameweekIndex}`;
}
...
function navigate(navDirection) {
    gameweekIndex += navDirection;
    filePath = `../data/view/aggregated-league-table-${gameweekIndex}.json`;
